...
class ContainerAnimatedCustomOffline extends StatefulWidget {
  final bool isAdm;
  final bool load;
  ...
  State<ContainerAnimatedCustomOffline> createState() =>
      _ContainerAnimatedCustomOfflineState();
}

class _ContainerAnimatedCustomOfflineState
    extends State<ContainerAnimatedCustomOffline> {
  bool open = false;
  bool about = false;
  bool enter = false;
  bool notFound = false;
