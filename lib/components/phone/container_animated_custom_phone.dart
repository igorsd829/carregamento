...
class ContainerAnimatedCustomPhone extends StatefulWidget {
  final bool isAdm;
  final bool load;
  ...
  const ContainerAnimatedCustomPhone({
    required this.index,
    required this.user,
    required this.load,
    required this.isAdm,
  ...
  @override
  State<ContainerAnimatedCustomPhone> createState() =>
      _ContainerAnimatedCustomPhoneState();
}

class _ContainerAnimatedCustomPhoneState
    extends State<ContainerAnimatedCustomPhone> {
  bool open = false;
  bool about = false;
  bool enter = false;
  bool notFound = false;
                            ...
                            child: Material(
                              ...
                              child: widget.load
                                  ...
                                  : InkWell(
                                      ...
                                      onLongPress: () {
                                        users.addTruckListLoading(widget.user);
                                      },
                                      child: IconButton(
