...
class TrucksScheduled extends StatefulWidget {
  final bool isAdm;

  const TrucksScheduled({required this.isAdm, super.key});

  @override
  State<TrucksScheduled> createState() => _TrucksScheduledState();
}

var alturaAppBar = AppBar().preferredSize; // altura da Appbar

class _TrucksScheduledState extends State<TrucksScheduled> {
  // @override
  // void initState() {
