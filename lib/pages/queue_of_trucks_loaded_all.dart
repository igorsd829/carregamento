...
class QueueOfTrucksLoadedAll extends StatefulWidget {
  final bool isAdm;

  const QueueOfTrucksLoadedAll({required this.isAdm, super.key});

  @override
  State<QueueOfTrucksLoadedAll> createState() => _QueueOfTrucksLoadedAllState();
}

var alturaAppBar = AppBar().preferredSize; // altura da Appbar

class _QueueOfTrucksLoadedAllState extends State<QueueOfTrucksLoadedAll> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    int coluns = 4;
    if (users.listTrucksAllLoaded.length <= 15) {
      coluns = 4;
    } else if (users.listTrucksAllLoaded.length >= 30 &&
        users.listTrucksAllLoaded.length <= 45) {
      coluns = 4;
    } else if (users.listTrucksAllLoaded.length >= 45 &&
        users.listTrucksAllLoaded.length <= 60) {
      coluns = 5;
    } else if (users.listTrucksAllLoaded.length >= 60 &&
        users.listTrucksAllLoaded.length <= 75) {
      coluns = 6;
    } else if (users.listTrucksAllLoaded.length >= 75 &&
        users.listTrucksAllLoaded.length <= 90) {
      coluns = 7;
    } else if (users.listTrucksAllLoaded.length >= 90 &&
        users.listTrucksAllLoaded.length <= 105) {
      coluns = 8;
    } else if (users.listTrucksAllLoaded.length >= 105 &&
        users.listTrucksAllLoaded.length <= 120) {
      coluns = 9;
    } else if (users.listTrucksAllLoaded.length > 120) {
      coluns = 11;
    }
    var larguraCard = larguraDaTela / coluns;
    List<UserPlate> trucksLoadedAll = [];
    users.listTrucksAllLoaded.forEach(
      (key, value) {
        trucksLoadedAll.add(value);
      },
    );
      ...
      child: Scaffold(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontSize: isPortraitPhoneSize ? 8 : 9,
                                ...
                                child: ElevatedButton(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            'TOTAL DO MÊS: ${users.countTrucksAllLoaded}º',
          ...
          body: isLandScape
              ? Padding(
                  ...
                  child: ListView(
                      children: trucksLoadedAll.map((e) {
                    int index = trucksLoadedAll.indexOf(e);
                    return Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${index + 1}/${users.countTrucksAllLoaded}',
                                style: TextStyle(
                                  fontSize: textScale * 8,
                                  color: Colors.black87,
                                ),
