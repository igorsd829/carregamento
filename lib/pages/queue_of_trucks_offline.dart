...
class QueueOfTrucksOffline extends StatefulWidget {
  final bool isAdm;
  final bool load;

  const QueueOfTrucksOffline(
      {required this.isAdm, required this.load, super.key});

  @override
  State<QueueOfTrucksOffline> createState() => _QueueOfTrucksOfflineState();
}

var alturaAppBar = AppBar().preferredSize; // altura da Appbar

class _QueueOfTrucksOfflineState extends State<QueueOfTrucksOffline> {
  // @override
  // void initState() {
